...
export default function Example() {
  ...
  return (
    <header className="relative isolate z-10 bg-white w-full py-4 2xl:px-32 xl:px-32 lg:px-12">
      <nav
      ...
      >
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end gap-3">
          <button
            type="button"
            className="text-blackberry-300 font-quicksand font-bold rounded-md bg-white px-3.5 py-2.5 text-base text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 "
          ...
          <button
            type="button"
            className="text-white font-quicksand font-bold rounded-md bg-blackberry-300 px-3.5 py-2.5 text-base font-semibold text-white shadow-sm hover:opacity-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                ...
                <a
                  href="#"
                  className="font-quicksand font-bold -mx-3 block font-quicksand font-bold rounded-lg px-3 py-2 text-base leading-7 text-gray-900 hover:bg-gray-50"
                >
                  Novels
                </a>
                <a

    ...
    <>
      ...
      */}
      <div className="flex min-h-full">
        <div className=" flex-col hidden flex-1 lg:block w-1/8 h-screen overflow-auto ">
          <div className="relative">
            <div className="flex flex-row absolute -bottom-14 left-1/2 transform -translate-x-1/2 justify-center">
              <div className="animate-bounce bg-white py-2 text-center rounded-2xl px-10 border-purple-500 border-2">
                <div className="text-lg font-bold">Quick Stories</div>
                <div className="text-lg font-bold -mt-2">(Piku Lore)</div>
                <div className="text-sm ">read now</div>
                <div>↓ </div>
              </div>
            </div>

            <Image src={Cover} className="w-full" alt={""}></Image>
          </div>
          <Image src={Page1} className="w-full" alt={""}></Image>
          <Image src={Page2} className="w-full" alt={""}></Image>
          <Image src={Page3} className="w-full" alt={""}></Image>
          <Image src={Page4} className="w-full" alt={""}></Image>
        </div>
              ...
              <div>
                <form action="#" method="POST" className="space-y-6">
                  <div>
                    ...
                    <div className="mt-2">
                      <input
                        ...
                        autoComplete="email"
                        placeholder="Kerbasi"
                        className="block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-500 sm:text-sm sm:leading-6"
                      />
                    </div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      <input
                        ...
                        name="link"
                        type="text"
                        placeholder="https://gdrive.com/art-links"
                        autoComplete="email"
                        className="block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-500 sm:text-sm sm:leading-6"
                      />
                    </div>
                  ...
                  <div>
                    <button
                      type="button"
                      className="flex w-full justify-center rounded-md bg-violet-500 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-violet-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-500"

...
export default function NovelName() {
  return (
    <>
      <main className="relative h-screen place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8 w-screen animate-fade-up animate-ease-in-out hide-scrollbar">
        <div className="flex flex-col w-1/3 border-2 border-violet-300 rounded-2xl p-10 gap-4 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          <div className="flex ">
            <Link href={"/"}>
              <svg
                width="95"
          ...
          <h1 className="mt-4 text-4xl font-bold tracking-tight text-blackberry-300">
            Contact Support
          </h1>
            ...
            <div className="w-full">
              ...
              <div className="mt-2">
                <input
                  ...
                  name="email"
                  id="email"
                  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-500 sm:text-sm sm:leading-6"
                  placeholder="Aisle"
          ...
          <div className="w-full">
            ...
            <div className="mt-2">
              <textarea
                ...
                name="email"
                id="email"
                className="resize-none block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-500 sm:text-sm sm:leading-6"
                placeholder="Write down your reasons..."
                aria-describedby="email-description"
              />
            </div>
          </div>
